...
public class MainActivity extends AppCompatActivity {
    ...
    Spinner spnSelector;
    String[] arreglos = {"Hay que aprender el oficio para ser el mejor, no vale sólo con el talento"
            ,"La velocidad de la cabeza es más importante que la de las piernas",
            "Es increíble como la pasión del fútbol une a tanta gente"};
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {//Orange
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent intent2 = new Intent(MainActivity.this,GreenActivity.class);
                        intent2.putExtra("DATA_FRASES_CELEBRES",arreglos[1]);

                        startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 = new Intent(MainActivity.this,BlueActivity.class);
